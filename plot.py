...
if __name__ == "__main__":
    fpath = "logs/smgsv_cp_or_gen/train.log"
    savepath = "logs/smgsv_cp_or_gen/trainLoss.png"
    accu_saveapth = "logs/smgsv_cp_or_gen/accuracy_train.png"
